...
![SERDS 双波长光谱示意：绝对波数坐标下 λ₁ (785.4 nm) 与 λ₂ (784.9 nm) 激发，拉曼峰移动、荧光不动；差分 ΔS(ν̃) 后荧光抵消、拉曼残留为一阶导数峰](assets/serds_dual_wavelength_spectrum.svg)
...
> 标注 `（待补充）` 者为本简报凭记忆列出但本次未直接核对的编号，请审核时补充检索。
...
> 本简报在 **§2.2 坐标对偶性** 和 **§2.3 Kasha 规则** 处强依赖 **拉曼光谱基础**，但未在本文展开。
> 

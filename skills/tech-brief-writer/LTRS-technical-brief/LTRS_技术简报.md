...
文档性质: 技术档案 / 物化实验教学备选
建立日期: 2026-07-06
最后修订: 2026-07-10（依据 SKILL.md v3.3.0 升级：优化文档头呈现）
作者: 化学智能体 - CherryClaw
发起人: 司承运
---
...
> **算例 + 适用条件**：从 1064 nm 改到 785 nm 激发，频率提升 1.35 倍 ⇒ 拉曼散射截面 ∝ `ν⁴` 提升约 **3.3 倍**。这是为何教学/科研常用可见–近红外（532/633/785 nm）而非深红 1064 nm：信噪比改善，但要付出"荧光背景与光损伤加剧"的代价——这又是 §2.1 中 trade-off 的具体体现。
>
...
- *v6（2026-07-10）★：按 `SKILL.md` v3.3.0 升级—— **元内容、目录不再单独生成序号**（按 §三·3.2 末尾必填）；原 §3 ~ §15 内容变为 §1 ~ §13，并修正链接。*
...
>
> > 本简报在 **§4 基本公式方程** 和 **§5 结构光变体** 处强依赖 **拉曼光谱基础** 与 **光镊基础** 两项基础技术，但按 §三·3.4 规则未在本文展开。
> >
